...
Markdown поддерживает возможность разметки таблиц. Для этого используются вертикальные линии («|») для обозначения столбцов, и символы дефис («-») для отделения строк. Внутри таблиц поддерживается выравнивание трёх типов:
- По левому краю
- По центру
- По правому краю
...
| ------------- |:------------------:| -----:|
| Тут будет выравнивание по левому краю     | Тут будет выравнивание по центру    |  Тут будет выравнивание по правому краю|
| Тут будет выравнивание по левому краю   | Тут будет выравнивание по центру |   Тут будет выравнивание по правому краю |
| Тут будет выравнивание по левому краю | Тут будет выравнивание по центру     |   Тут будет выравнивание по правому краю |
```
