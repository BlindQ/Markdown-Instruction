...
В Markdown существует несколько возможностей для выделения текста. Как и вклассических текстовых редакторов поддерживается *курсивное выделение*, **жирное выделение**, ~~зачеркивание~~, ****жирное и курсивное выделение***, <font face = "Arial"> Изменение типа шрифта </font>, <font size = 5> изменение кегеля </font>
